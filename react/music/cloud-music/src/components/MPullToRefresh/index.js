...
class MPullToRefresh extends React.Component {
  ...
  render() {
    ...
    return (
      <div
        className='m-pull-to-refresh-container'
        ref={(_ref) => {
          this.wrapRef = _ref;
        }}
        style={{ ...iOSDebouneDisabled }}
      >
        <div
        ...
        >
          <div className="m-pull-to-refresh-header">
            <Header status={ptRfresh} />
          </div>
          ...
          <div className="m-pull-to-refresh-footer">
            <Footer status={ptMore} hasMore={hasMore} />
          </div>
        </div>
      </div>
    );
